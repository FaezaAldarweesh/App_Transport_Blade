...
class BusController extends Controller
{
    ...
    public function __construct(BusService $busservices)
    {
        ...
        $this->middleware(['role:Admin', 'permission:buses|buse management'])->only('index');
        $this->middleware(['role:Admin', 'permission:show bus trip'])->only('show');
        ...
        $this->middleware(['role:Admin', 'permission:trashed bus management'])->only('all_trashed_bus');
