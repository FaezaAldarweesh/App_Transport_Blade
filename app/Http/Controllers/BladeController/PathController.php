...
class PathController extends Controller
{
    ...
    public function __construct(PathService $pathservices)
    {
        ...
        $this->middleware(['role:Admin', 'permission:paths|path management'])->only('index');
        $this->middleware(['permission:show path stations'])->only('show');
        ...
        $this->middleware(['role:Admin', 'permission:trashed path management'])->only('all_trashed_bus');
