                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="{{ route('trip_tracks_map', $trip->id) }}"
                                           class="btn btn-info btn-sm shadow-sm">
                                        ...
                                        @can('update trip status')
                                            <form action="{{ route('update_trip_status', $trip->id) }}" method="POST"
                                                  class="d-inline-block">
                                                @csrf
                                        ...
                                        @can('all student trip')
                                            <a href="{{ route('checkout.show',$trip->id) }}"
                                               class="btn btn-warning btn-sm text-white shadow-sm">
                                        ...
                                        @can('absences / transfar')
                                            <a href="{{ route('all_student_trip', $trip->id) }}"
                                               class="btn btn-info btn-sm shadow-sm">
